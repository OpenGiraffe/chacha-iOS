...
/** 静音按钮 */
@property (strong, nonatomic)   LLRTCButton               *muteBtn;
/** 摄像头按钮 */
@property (strong, nonatomic)   LLRTCButton               *cameraBtn;
/** 扬声器按钮 */
@property (strong, nonatomic)   LLRTCButton               *loudspeakerBtn;
/** 邀请成员按钮 */
@property (strong, nonatomic)   LLRTCButton               *inviteBtn;
/** 消息回复按钮 */
@property (strong, nonatomic)   UIButton                *msgReplyBtn;
/** 收到视频通话时，语音接听按钮 */
@property (strong, nonatomic)   LLRTCButton               *voiceAnswerBtn;
/** 挂断按钮 */
@property (strong, nonatomic)   LLRTCButton               *hangupBtn;
/** 接听按钮 */
@property (strong, nonatomic)   LLRTCButton               *answerBtn;
/** 收起按钮 */
@property (strong, nonatomic)   LLRTCButton               *packupBtn;
/** 视频通话缩小后的按钮 */
@property (strong, nonatomic)   UIButton                *videoMicroBtn;
/** 音频通话缩小后的按钮 */
@property (strong, nonatomic)   LLRTCButton               *microBtn;
/** 遮罩视图 */
...
- (LLRTCButton *)swichBtn
{
    if (!_swichBtn) {
        _swichBtn = [[LLRTCButton alloc] initWithTitle:nil noHandleImageName:@"icon_avp_camera_white"];
...
{
    if (!_muteBtn) {
        _muteBtn = [[LLRTCButton alloc] initWithTitle:@"静音" imageName:@"icon_avp_mute" isVideo:_isVideo];
...
- (LLRTCButton *)cameraBtn
{
    if (!_cameraBtn) {
        _cameraBtn = [[LLRTCButton alloc] initWithTitle:@"摄像头" imageName:@"icon_avp_video" isVideo:_isVideo];
...
- (LLRTCButton *)loudspeakerBtn
{
    if (!_loudspeakerBtn) {
        _loudspeakerBtn = [[LLRTCButton alloc] initWithTitle:@"扬声器" imageName:@"icon_avp_loudspeaker" isVideo:_isVideo];
...
- (LLRTCButton *)inviteBtn
{
    if (!_inviteBtn) {
        _inviteBtn = [[LLRTCButton alloc] initWithTitle:@"邀请成员" imageName:@"icon_avp_invite" isVideo:_isVideo];
...
- (LLRTCButton *)hangupBtn
{
    if (!_hangupBtn) {
        if (_callee && !_answered) {
            _hangupBtn = [[LLRTCButton alloc] initWithTitle:@"拒绝"  noHandleImageName:@"icon_call_reject_normal"];
        } else {
            _hangupBtn = [[LLRTCButton alloc] initWithTitle:nil noHandleImageName:@"icon_call_reject_normal"];
        }
...
- (LLRTCButton *)packupBtn
{
    if (!_packupBtn) {
        _packupBtn = [[LLRTCButton alloc] initWithTitle:@"收起" imageName:@"icon_avp_reduce" isVideo:_isVideo];
...
- (UIButton *)msgReplyBtn
{
    if (!_msgReplyBtn) {
        if (self.isVideo) {
            _msgReplyBtn = [[LLRTCButton alloc] initWithTitle:@"消息回复" noHandleImageName:@"icon_av_reply_message_normal"];
        } else {
...
- (LLRTCButton *)voiceAnswerBtn
{
    if (!_voiceAnswerBtn) {
        _voiceAnswerBtn = [[LLRTCButton alloc] initWithTitle:@"语音接听" noHandleImageName:@"icon_av_audio_receive_normal"];
...
- (LLRTCButton *)answerBtn
{
    if (!_answerBtn) {
        _answerBtn = [[LLRTCButton alloc] initWithTitle:@"接听" noHandleImageName:@"icon_audio_receive_normal"];
        [_answerBtn addTarget:self action:@selector(answerClick) forControlEvents:UIControlEventTouchUpInside];
    }
    return _answerBtn;
}

- (LLRTCButton *)microBtn
{
    if (!_microBtn) {
        _microBtn = [[LLRTCButton alloc] initWithTitle:@"等待中" noHandleImageName:@"icon_av_audio_micro_normal"];
